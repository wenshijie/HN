...
SELECT count(DISTINCT userid)
    from dw_log.dw_apppagelog
     where day>='20180709' 
    	and day<'20180716' 
    	and (current_page='PurchaseListActivity' or current_page ='PurchaseListViewController')
#采购大厅访问手机设备数
...
from 
	...
	(SELECT deviceid,model
		...
		where day='20180715'
									...
									-- 【去掉和加上（or current_page ='FindGoodsViewController'ios采购大厅埋点）差值刚好为null的值】
GROUP BY b.model
#采购大厅 手机屏幕
