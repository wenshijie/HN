...
from 
	...
	(SELECT deviceid,model
		...
		where day='20180715'
									...
									-- 【去掉和加上（or current_page ='FindGoodsViewController'ios我的埋点）差值刚好为null的值】
GROUP BY b.model
#我的 手机屏幕
...
from 
	...
	(select hnuserid,cate_name3
	from dw_log.dw_supply_inquiry
	where day>='20180709' and day<'20180716' and eventid='call_click'--电话询盘
	)b on a.userid=b.hnuserid
GROUP BY b.cate_name3