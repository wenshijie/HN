...
SELECT count(DISTINCT userid)
    from dw_log.dw_apppagelog
     where day>='20180709' 
    	and day<'20180716' 
    	and (current_page='SupplyListActivity' or current_page ='SupplyListViewController')
#供应大厅访问手机设备数
...
from 
	...
	(SELECT deviceid,model
		...
		where day='20180715'
									...
									-- 【去掉和加上（or current_page ='FindGoodsViewController'ios供应大厅埋点）差值刚好为null的值】
GROUP BY b.model
#供应大厅 手机屏幕
